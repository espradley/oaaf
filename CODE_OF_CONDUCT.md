...
privately to the maintainers by opening a
[private security advisory](https://github.com/espradley/oaaf/security/advisories/new)
on this repository, which is visible only to maintainers. A dedicated conduct contact
address will be published here once one is established.
...
2. **Warning** — A warning with consequences for continued behavior, including a
   specified period of no interaction with those involved.
